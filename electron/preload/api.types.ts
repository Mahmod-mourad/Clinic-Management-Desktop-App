...
export interface ElectronAPI {
  ...
  patients: {
    ...
    softDelete: (id: number) => Promise<IpcResponse>
  ...
  appointments: {
    ...
    update: (id: number, data: unknown) => Promise<IpcResponse<unknown>>
    updateStatus: (id: number, status: string) => Promise<IpcResponse>
    cancel: (id: number, reason: string) => Promise<IpcResponse>
  }
  medicalRecords: {
  ...
  invoices: {
    ...
    getById: (id: number) => Promise<IpcResponse<unknown>>
    getByPatient: (patientId: number) => Promise<IpcResponse<unknown[]>>
    create: (data: unknown) => Promise<IpcResponse<{ id: number; invoiceNumber: string }>>
    update: (id: number, data: unknown) => Promise<IpcResponse<unknown>>
    cancel: (id: number) => Promise<IpcResponse>
  ...
  settings: {
    ...
    setMany: (data: Record<string, string>) => Promise<IpcResponse>
    getUsers: () => Promise<IpcResponse<unknown[]>>
    createUser: (data: unknown) => Promise<IpcResponse>
    updateUser: (id: number, data: unknown) => Promise<IpcResponse>
  }
  backup: {
  ...
  license: {
    getStatus: () => Promise<IpcResponse<LicenseStatus>>
